...
function show_text_userid($db,$userid){
    $query = 'SELECT informs.name,informs.inform FROM informs INNER JOIN informs_users ON informs.id=informs_users.inform_id WHERE informs_users.user_id='.$userid;
